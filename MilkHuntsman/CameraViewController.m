...
{
    //拍照按钮
    _shutterBtn=[[UIButton alloc]initWithFrame:CGRectMake(WindownWidth-50, WindowHeight-60, 30, 40)];
...
{
    //1x 2x 3x 4x焦距按钮
    _focalBtn=[[UIButton alloc]initWithFrame:CGRectMake(20, WindowHeight-110, 40, 30)];
...
- (void)returnLastPage{
    ...
    _returnBtn.frame = CGRectMake(360, 540, 40, 30);
    
    [_returnBtn setImage:[UIImage imageNamed:@"left_round"] forState:UIControlStateNormal];
    [_returnBtn setImage:[UIImage imageNamed:@"left_circular"] forState:UIControlStateHighlighted];
    _returnBtn.backgroundColor = [UIColor colorWithWhite:0.8 alpha:0.8];
    _returnBtn.layer.cornerRadius = 10;
    _returnBtn.layer.borderColor = [UIColor whiteColor].CGColor;
    _returnBtn.layer.borderWidth=1.0;
    _returnBtn.transform = CGAffineTransformMakeRotation(M_PI_2);
...
- (void)returnBtnAction:(UIButton *)returnBtn{
...
-(void)showCapturedImage:(UIImage *)image
{
    ...
    UIButton *saveBtn=[[UIButton alloc]initWithFrame:CGRectMake(xpos, WindowHeight-ypos, 60, 40)];
